    ...
    <div className="App">
      ...
      <div className="titleLineContainer">
        ...
        <div className="miscButtons" data-nosnippet="">
          ...
          <a id="spotifyLink" disabled={!playing?.isValid} target="_blank" rel="noopener noreferrer" title="current song on Spotify" className="iconBtn" style={{ fontSize: "initial" }} href={spotifyLink(playing)}>
          ...
          <button title="contact" onClick={contact} className="iconBtn">
            <svg viewBox="0 0 24 24">
